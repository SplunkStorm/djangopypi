...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.allow_authenticated'
        db.add_column('djangopypi_package', 'allow_authenticated', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Package.allow_authenticated'
        db.delete_column('djangopypi_package', 'allow_authenticated')
