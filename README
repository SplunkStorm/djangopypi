...
Before a user can upload a package they must be granted permission to do
so. In the admin interface assign the user the djangopypi.add_package
permission.

Failure to do so will give a 403 when uploading
